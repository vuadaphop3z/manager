...
//            var _baseUrl = string.Format("{0}/{1}", SystemSettings.PfoodSingleSignOnApi, "api/user/getinfo");
//            if (userId != 0)
//            {
//                model.UserId = userId;
//            }
...
//            var strError = string.Empty;
//            var result = new ResponseApiModel();
//            var _baseUrl = string.Format("{0}/{1}", SystemSettings.PfoodSingleSignOnApi, "api/user/getlistprofile");
